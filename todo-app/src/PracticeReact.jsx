  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", width: "50%", alignItems: "left", gap: 10, marginLeft: 20 }}>
      ...
      <div>
        ...
        <h3>User Form</h3>
        <form style={{ display: "flex", flexDirection: "column", gap: 10, border: "5px solid black", borderRadius: 10, padding: 10 }}>
          ...
          <div style={formFieldStyle}>
            ...
            <input type="file" accept="image/*" placeholder="Upload your Image" style={inputStyle} onChange={(e) => {
